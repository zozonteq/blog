---
date: 2024-12-31
aliases: nixだけでマイクラサーバーを構築する
tags: 
title: nixだけでマイクラサーバーを構築する
---
# はじめに
マイクラサーバーを新たに構築する機会があり、そこでnixを使ってサーバーを構築してみることにしたので、その時のお話です！
# Nixマイクラサーバーの利点
メリットは色々挙げられるのですが、１番の利点はテキストベースで宣言的に、そして構造的に構築できることだと思います。たとえばプロキシサーバーと、ロビーサーバーの二つを構築したいならこのように書けます
```nix
